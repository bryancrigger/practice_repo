...
layout = dict(
        title = "Number of individuals born outside of US, living in the US (2018)<br><span style='font-size:0.6em;color:gray'>Link to data <a href='https://www.migrationpolicy.org/data/state-profiles/state/demographics/US'>here.</a></span><span style='font-size:0.6em;color:gray'> Hover over diagram for more info on each flow.</span>",
